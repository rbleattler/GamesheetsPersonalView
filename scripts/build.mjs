...
appJs = appJs.replace(teamCardMarker, '<section class="panel hero team-dashboard-card"><div class="teamhero">${logo(t)}<div><div class="teamname">${esc(t.title)}</div><div class="muted">${esc(div)}</div></div><div class="right"><span class="pill team-badge">★ My Team</span></div></div><div class="statstrip team-statstrip"><div class="stat"><b>${esc(teamRecordText)}</b><small>Record</small></div><div class="stat"><b>${esc(summary.goalsFor)}</b><small>GF</small></div><div class="stat"><b>${esc(summary.goalsAgainst)}</b><small>GA</small></div><div class="stat"><b>${esc(teamPimPerGameText)}</b><small>PIM/G</small></div><div class="stat"><b title="${escAttr(teamNextTitle)}">${esc(teamNextShortText)}</b><small>Next</small></div></div><div class="team-card-actions"><button id="teamSchedule" class="soft team-action-btn"><span class="fa-icon fa-calendar-days" aria-hidden="true"></span><span class="btn-text">Schedule</span></button><button id="teamRoster" class="soft team-action-btn"><span class="fa-icon fa-users" aria-hidden="true"></span><span class="btn-text">Roster</span></button><button id="teamStatsBtn" class="soft team-action-btn"><span class="fa-icon fa-chart-line" aria-hidden="true"></span><span class="btn-text">Stats</span></button><button id="removeTeam" class="soft danger team-action-btn team-remove-btn" aria-label="Remove team" title="Remove team"><span class="fa-icon fa-trash-can" aria-hidden="true"></span><span class="btn-text">Remove</span></button></div></section>');
