...
const faCssSource = [
  ...
  '.player-tables-mobile .col-player{width:auto;min-width:var(--mhh-player-col,150px);position:sticky;left:0;z-index:2;background:#0e1a28;white-space:normal;overflow-wrap:break-word;line-height:1.25;box-shadow:7px 0 7px -7px rgba(0,0,0,.85)}',
