...
const faCssSource = [
  ...
  '.player-tables-mobile .player-table-scroll table{min-width:0;width:100%}.player-tables-mobile th,.player-tables-mobile td{padding:6px 3px;font-size:.74rem}.player-tables-mobile .col-icon{width:20px;padding-left:2px;padding-right:2px}.player-tables-mobile .col-icon .star{font-size:1rem}.player-tables-mobile .col-narrow{width:32px}.player-tables-mobile .col-num{width:32px}.player-tables-mobile .col-player{min-width:0}',
  '@media(max-width:560px){.player-tables-desktop{display:none}.player-tables-mobile{display:block}}',
