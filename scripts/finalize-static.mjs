...
const faCssSource = [
  ...
  '.player-tables-mobile .player-table-scroll table{min-width:0;width:100%}.player-tables-mobile td{padding:6px 3px;font-size:clamp(.7rem,3.4vw,.8rem)}.player-tables-mobile th{padding:6px 3px;font-size:clamp(.56rem,2.8vw,.68rem)}.player-tables-mobile .col-narrow{width:26px;text-align:center}.player-tables-mobile .col-num{width:32px}.player-tables-mobile .col-player{min-width:0}',
