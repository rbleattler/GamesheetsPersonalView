...
const faCssSource = [
  ...
  '.player-tables{display:grid;gap:16px}.player-subtable h4{margin:0 0 7px;font-size:.82rem;text-transform:uppercase;letter-spacing:.07em;color:var(--muted)}.player-table-scroll{overflow-x:auto;overflow-y:hidden;-webkit-overflow-scrolling:touch}.goalie-subtable{padding-top:2px;border-top:1px solid rgba(120,150,180,.14)}',
