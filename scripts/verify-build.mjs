...
if (!cardActionsJs.includes('game-action-row') || !cardActionsJs.includes('GameSheet') || !cardActionsJs.includes('LiveBarn') || !cardActionsJs.includes("label==='game'")) throw new Error('Game-card action-row decorator was not emitted correctly.');
